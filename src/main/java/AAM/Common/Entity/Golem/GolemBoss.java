package AAM.Common.Entity.Golem;

import AAM.Common.Entity.Elemental.ElementalBoss.State;
...
//TODO
public class GolemBoss extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
	public GolemBoss(World w)
	{
		super(w);
	...
	public enum State
	{
		Clear, Skill1, SKill2, SKill3, SKill4, Skill5;
		public int max;
