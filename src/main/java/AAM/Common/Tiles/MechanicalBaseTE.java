...
public class MechanicalBaseTE extends TileEntity
{
	...
	public void createCircleAbove()
	{
		...
		{
			WorldPos cl = new WorldPos(this).add(ForgeDirection.UP);
			this.worldObj.setBlock((int) cl.x, (int) cl.y, (int) cl.z, ModBlocks.TransCircle);
