...
public class ModSpear extends GameWeapon implements IExtendedReach
{
	...
	public ModSpear(String name, int baseDmg, boolean bypassesArmor, EnumChatFormatting rarity, String texture)
	{
