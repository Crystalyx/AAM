...
public class AABB2
{
	...
	{
		return (MiscUtils.isInLimit(aabb.ox, this.ox, this.tx) && MiscUtils.isInLimit(aabb.oy, this.oy, this.ty)) || (MiscUtils.isInLimit(aabb.tx, this.ox, this.tx) && MiscUtils.isInLimit(aabb.oy, this.oy, this.ty))
				|| (MiscUtils.isInLimit(aabb.tx, this.ox, this.tx) && MiscUtils.isInLimit(aabb.ty, this.oy, this.ty)) || (MiscUtils.isInLimit(aabb.ty, this.oy, this.ty) && MiscUtils.isInLimit(aabb.ox, this.ox, this.tx));
	}
