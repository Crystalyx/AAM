...
public class CreativeCauldronRenderer extends TileEntitySpecialRenderer
{
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float p_147500_8_)
	{
		...
		ResourceLocation txt = new ResourceLocation("aam:textures/misc/Cauldron-creative-texture.png");
		...
		if (tile != null)
		{
			if (tile instanceof CreativeCauldronTileEntity)
			{
				CreativeCauldronTileEntity cauld = (CreativeCauldronTileEntity) tile;
